...
const Register: React.FC = () => {
  const {
    ...
    z.input<typeof registerWithConfirmSchema>,
    any,
    z.infer<typeof registerWithConfirmSchema>
  >({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-112.5 w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.05)] border border-gray-100">
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              render={({ field }) => (
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent className="bg-white border border-gray-200 shadow-md rounded-xl z-50">
                    <SelectItem
                      value="applicant"
                      className="cursor-pointer py-2 hover:bg-gray-50 focus:bg-gray-50 rounded-lg outline-none transition-colors"
                    >
                      Job Applicant
                    </SelectItem>
                    <SelectItem
          ...
          <Button
            type="submit"
            className="w-full bg-[#1877F2] hover:bg-blue-700 text-white py-6 text-base rounded-xl mt-4 font-semibold"
          >
            Create Account
          </Button>
